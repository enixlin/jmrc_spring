            ...
            getProductClientDetail: function(container, product, start, end) {
                ...
                let grid = Ext.create({
                    ...
                    columns: [
                        ...
                        { text: '笔数<br>同比', dataIndex: "times_compare", width:80,renderer:function(v){	
                        	if(v<0){
                        ...
                        { text: '金额<br>同比', dataIndex: "amount_compare", width: 150,renderer:function(v){	if(v<0){
...
>>>>>>> d143b869030b6aa66f96046c2e9c92eca59192ec
